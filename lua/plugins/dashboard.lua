	...
	opts = {
		dashboard = {
			...
			sections = {
				{ text = "", padding = 2 },
				{
					text = "Welcome Back, Xyrel",
					hl = "SnacksDashboardSpecial",
					align = "center",
				},
				{ section = "startup", padding = 1, align = "center" },
				{ text = "", padding = 1 },
				{
					pane = 1,
					indent = 5,
				...
				},
				{
					pane = 2,
					indent = 5,
					{ title = "Projects", padding = 1, hl = "SnacksDashboardSpecial" },
					{ section = "projects", limit = 5, padding = 2 },
					{ text = "", padding = 1 },
					{ title = "Recent Files", padding = 1, hl = "SnacksDashboardSpecial" },
					{ section = "recent_files", limit = 8, padding = 2 },
				},
				{ section = "keys", hidden = true },
			},
		},
